...
import me.egli.brewExampleAddon.keybinds.ExampleKeybind;
...
import me.egli.brewhack.core.keybind.Keybinds;
...
public class BrewExampleAddon extends BrewAddon {
    ...
    public void onInitialize() {
        ...
        Keybinds.add(new ExampleKeybind());
        HudModules.add(new ExampleHud());
